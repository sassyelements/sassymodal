...
var _sassyModal = require("./js/plugins/SassyModal");
...
class SassyModal {
    constructor(config){
        ...
        if (typeof config === "object") this.options = {
            ...this.options,
            ...config
        };
    ...
    setTriggers() {
        ...
        if (triggers.length > 0) triggers.forEach((trigger)=>{
    ...
    setClosers() {
        ...
        if (modals.length > 0) modals.forEach((modal)=>{
        ...
        if (closeBtns.length > 0) closeBtns.forEach((btn)=>{
...
},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire741b")
